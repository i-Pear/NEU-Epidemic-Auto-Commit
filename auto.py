...
def run():
    ...
    driver.get('https://e-report.neu.edu.cn/inspection/items/'+sys.argv[1]+'/records/create')

    time.sleep(3)

    driver.execute_script('document.getElementById("txt_temperature").value="36.5"')

    button = driver.find_element_by_xpath('//*[@id="app"]/form/div[5]/input')
    button.click()
